...
#ifndef BAKE_RTI_CONNEXT_BAKE_CONFIG_H
#define BAKE_RTI_CONNEXT_BAKE_CONFIG_H
...
/* Convenience macro for exporting symbols */
    ...
    #define BAKE_RTI_CONNEXT_EXPORT __declspec(dllimport)
  #else
    #define BAKE_RTI_CONNEXT_EXPORT
  #endif
#else
  #define BAKE_RTI_CONNEXT_EXPORT
#endif
